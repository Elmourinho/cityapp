package com.elmar.cityapp.exception;

import com.elmar.cityapp.constants.HttpResponseConstants;
import com.elmar.cityapp.errors.ConstraintsViolationError;
...
public class GlobalExceptionHandler extends DefaultErrorAttributes {
  ...
  public ResponseEntity<Map<String, Object>> handle(CityException ex,
                                                    WebRequest request) {
  ...
  public final ResponseEntity<Map<String, Object>> handle(
    ...
    List<ConstraintsViolationError> validationErrors = ex.getBindingResult()
                                                         .getFieldErrors()
                                                         .stream()
                                                         .map(error -> new ConstraintsViolationError(error.getField(),
  ...
  protected ResponseEntity<Map<String, Object>> ofType(WebRequest request,
                                                       HttpStatus status, CityException ex) {
